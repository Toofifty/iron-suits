...
public class ShapedAlloy implements IRecipe {
	...
	public ShapedAlloy(int par1, int par2,
	...
	public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting) {
		...
		System.out.println("Crafting result found = " + itemstack.getDisplayName());
		return itemstack;
	}
	...
	public ShapedAlloy func_92100_c() {
