...
public class ModelLightHelmet extends ModelArmorBase {
	...
	public ModelLightHelmet(float f) {
		...
		facebrowright = new ModelRenderer(this, 0, 32);
		...
		topmain.addBox(-4F, -8.5F, -4F, 8, 1, 8);
		...
		leftmain.addBox(3.5F, -8F, -4F, 1, 8, 8);
		...
		rightmain.addBox(-4.5F, -8F, -4F, 1, 8, 8);
		...
		backleft.addBox(2.9F, -6.583333F, 3.7F, 1, 2, 1);
		...
		backright.addBox(-3.9F, -6.583333F, 3.733333F, 1, 2, 1);
